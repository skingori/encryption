...
if(isset($_POST['add'])) {
    $Department_Id_ =$_POST['Department_Id'];
    ...
    $sql = "INSERT INTO  Department_table(Department_Id,Department_Name,Department_Faculty)
VALUES ('$Department_Id_' ,'$Department_Name_','$Department_Faculty_')";
...
<?php include "header.php";?>
    ...
    <form id="" method="POST">
        ...
        <div class="form-group label-floating">
            ...
            <input type="text" class="form-control" required name="Department_Id">
        </div>
        <div class="form-group label-floating">
