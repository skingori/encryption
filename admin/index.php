    ...
    <div class="card">
        ...
        <div class="">
            <table class="table table-responsive table-condensed table-bordered" style="font-family: 'Apple Color Emoji'">
                ...
                $result = mysqli_query($con, "SELECT * FROM cipher_table ORDER BY cipher_id ASC");
                ...
                while($res = mysqli_fetch_array($result)) {
                    ...
                    echo "<td><a href=\"assig-decrypt.php?id=$res[cipher_id]\" onClick=\"return confirm('Are you sure you want to decrypt?')\" class='fa fa-user-secret lg-2'></a></td>";
                    echo "<td><a href=\"delete.php?id=$res[cipher_id]\" onClick=\"return confirm('Are you sure you want to delete?')\" class='fa fa-trash-o lg-2'></a></td>";
